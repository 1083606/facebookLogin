...
import chaui.adapter.ChatAdapter;
import chaui.bean.AudioMsgBody;
import chaui.bean.FileMsgBody;
import chaui.bean.ImageMsgBody;
import chaui.bean.Message;
import chaui.bean.MsgSendStatus;
import chaui.bean.MsgType;
import chaui.bean.TextMsgBody;
import chaui.bean.VideoMsgBody;
import chaui.util.ChatUiHelper;
import chaui.util.FileUtils;
import chaui.util.LogUtil;
import chaui.util.PictureFileUtil;
import chaui.widget.MediaManager;
import chaui.widget.RecordButton;
import chaui.widget.StateButton;
