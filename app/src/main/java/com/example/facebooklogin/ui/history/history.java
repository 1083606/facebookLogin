...
public class history {
    ...
    public history(String chatroom_id, String user_id, String habbit_name, String habbit_status, String completion, String max_completion, String created_at, String updated_at) {
